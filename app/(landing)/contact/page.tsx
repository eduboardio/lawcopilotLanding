...
export default function ContactPage() {
  ...
  return (
    <section className="container px-4 sm:px-6 py-12 md:py-20 lg:py-24 relative overflow-hidden">
      <div className="absolute -top-16 -right-32 w-64 h-64 bg-primary/10 rounded-full blur-3xl hidden sm:block"></div>
      <div className="absolute -bottom-24 -left-32 w-72 h-72 bg-secondary/10 rounded-full blur-3xl hidden sm:block"></div>
