      ...
      <Card className="mx-auto max-w-4xl">
        <CardContent className="pt-4 md:pt-6">
          <div className="prose prose-slate dark:prose-invert max-w-none text-sm md:text-base">
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4">Personal Identification Information</h2>
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4 mt-6 md:mt-8">Non-personal Identification Information</h2>
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4 mt-6 md:mt-8">Web Browser Cookies</h2>
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4 mt-6 md:mt-8">Use and Sharing of Information</h2>
            <ul className="pl-5 space-y-2">
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4 mt-6 md:mt-8">Security</h2>
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4 mt-6 md:mt-8">Changes to This Privacy Policy</h2>
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4 mt-6 md:mt-8">Acceptance of These Terms</h2>
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-3 md:mb-4 mt-6 md:mt-8">Contacting Us</h2>
