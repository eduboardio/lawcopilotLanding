    ...
    return (
        <section className="relative w-full overflow-hidden bg-background py-16 md:py-20">
            ...
            <div className="container relative z-10 mx-auto max-w-7xl px-6">
                ...
                >
                    <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-border bg-card/50 px-4 py-2 backdrop-blur-sm dark:border-white/10 dark:bg-white/[0.03]">
                    ...
                    <h2 className="mb-4 text-3xl font-bold tracking-tight text-foreground md:text-4xl dark:text-white">
                        Committed to the Highest Security Standards
                    </h2>

                    <p className="mx-auto max-w-2xl text-base leading-relaxed text-muted-foreground dark:text-white/70">
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {certifications.map((cert, index) => {
                        ...
                        return (
                            ...
                            >
                                {/* Card */}
                                <div className="relative h-full rounded-xl border border-border bg-card/80 p-6 backdrop-blur-sm transition-all duration-300 hover:border-border/80 hover:shadow-lg dark:border-white/10 dark:bg-white/[0.03] dark:hover:border-white/20">
                                    {/* Icon */}
                                    <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-muted dark:bg-white/10">
                                    ...
                                    {/* Badge */}
                                    <div className="mt-4 inline-flex items-center justify-center rounded-full border border-border bg-muted/50 px-3 py-1 dark:border-white/10 dark:bg-white/5">
                                        <span className="text-xs font-medium text-foreground dark:text-white/70">
                                            {cert.badge}
                                        </span>
                                    </div>
                                </div>
