// Edge-compatible persistence using simple string concatenation
// This runs in middleware (Edge Runtime)
...
// }
//
// const RATE_LIMIT_FILE = joinPath(PERSISTENCE_DIR, 'rate-limits.json');
// const IP_BLOCKS_FILE = joinPath(PERSISTENCE_DIR, 'ip-blocks.json');
// const MONITORING_FILE = joinPath(PERSISTENCE_DIR, 'monitoring.json');
// const QUOTA_FILE = joinPath(PERSISTENCE_DIR, 'quota.json');
